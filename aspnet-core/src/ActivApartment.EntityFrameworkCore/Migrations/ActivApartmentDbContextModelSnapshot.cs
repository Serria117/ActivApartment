...
{
    [DbContext(typeof(ActivApartmentDbContext))]
    partial class ActivApartmentDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivApartment.DomainEntities.Building.BuildingEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ActivApartment.DomainEntities.Building.BuildingType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ActivApartment.DomainEntities.GuestService.GuestServiceEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("guest_service");
                });

            modelBuilder.Entity("ActivApartment.DomainEntities.GuestService.ServiceCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ActivApartment.DomainEntities.Room.RoomEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ActivApartment.Locations.Country", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("Code", "CountryName")
                        .IsUnique();

                    b.ToTable("country");
                });

            modelBuilder.Entity("ActivApartment.Locations.District", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ActivApartment.Locations.Province", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ActivApartment.Locations.Ward", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ActivApartment.DomainEntities.GuestService.GuestServiceEntity", b =>
                {
                    b.HasOne("ActivApartment.DomainEntities.GuestService.ServiceCategory", null)
                        .WithMany("GuestServiceEntities")
            ...
            modelBuilder.Entity("ActivApartment.DomainEntities.Room.RoomEntity", b =>
                {
                    b.HasOne("ActivApartment.DomainEntities.Building.BuildingEntity", "Building")
                        .WithMany()
            ...
            modelBuilder.Entity("ActivApartment.DomainEntities.GuestService.ServiceCategory", b =>
                {
                    b.Navigation("GuestServiceEntities");
                });
