...
namespace ActivApartment.Migrations
{
    ...
    [Migration("20221017015555_update-relationship")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActivApartment.Building.BuildingEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ActivApartment.Building.BuildingType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ActivApartment.Room.RoomEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ActivApartment.Building.BuildingEntity", b =>
                {
                    b.HasOne("ActivApartment.Building.BuildingType", "BuildingType")
                        .WithMany()
                        .HasForeignKey("BuildingTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ActivApartment.Locations.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ActivApartment.Locations.District", "District")
                        .WithMany()
                        .HasForeignKey("DistrictId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ActivApartment.Locations.Province", "Province")
                        .WithMany()
                        .HasForeignKey("ProvinceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ActivApartment.Locations.Ward", "Ward")
                        .WithMany()
            ...
            modelBuilder.Entity("ActivApartment.Room.RoomEntity", b =>
                {
                    b.HasOne("ActivApartment.Building.BuildingEntity", "Building")
                        .WithMany()
